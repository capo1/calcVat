...
class calcVat {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      calcVat_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $calcVat    The string used to uniquely identify this plugin.
	 */
	protected $calcVat;
	 ...
	 *
	 * - calcVat_Loader. Orchestrates the hooks of the plugin.
	 * - calcVat_i18n. Defines internationalization functionality.
	 * - calcVat_Admin. Defines all hooks for the admin area.
	 * - calcVat_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the calcVat_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
